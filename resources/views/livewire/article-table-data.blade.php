        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3">{{__('messages.author')}}</th>
                    <th scope="col" class="px-4 py-3">{{__('messages.category')}}</th>
                    <th scope="col" class="px-4 py-3">{{__('messages.pdf')}}</th>
                    @can('update article')
                        <th scope="col" class="py-3 text-center">{{__('messages.read')}}</th>
                        <th scope="col" class="py-3 text-center">{{__('messages.download')}}</th>
                    @endcan
