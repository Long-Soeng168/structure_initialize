                ...
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            <a href="{{ asset('assets/images/cards/' . $item->image) }}" class="glightbox">
                                <img src="{{ asset('assets/images/cards/thumb/' . $item->image) }}"
                        ...
                        <x-table-data class="text-center uppercase" value="{{ $item->order_index }}" />
