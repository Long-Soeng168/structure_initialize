<div>
    ...
    <div
                            ...
                            @foreach ($categories as $category)
                                <li class="flex items-center">
                                    <button wire:click.prevent='setFilter("{{ $category->name }}")'>
                                        <p
                                            class="ml-2 text-sm uppercase font-medium text-gray-900 dark:text-gray-100 text-left hover:underline {{ $category->id == $filter ? 'underline' : '' }}">
                                            {{ $category->name }}
                                        </p>
        ...
        <div
            ...
            @can('create page')
                <x-primary-button href="{{ route('admin.headings.create') }}">
                            ...
                            <div class="flex items-start justify-center gap-3">
                                ...
                                @can('view page')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('headings/' . $item->id) }}" @mouseenter="tooltip = true"
                                ...
                                @can('update page')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/headings/' . $item->id . '/edit') }}"
