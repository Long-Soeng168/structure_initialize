<div>
    ...
    <div
        ...
        <div
            ...
            @can('create news')
                <x-primary-button href="{{ route('admin.news.create') }}">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="py-3 text-center">{{__('messages.user')}}</th>
                    <th scope="col" class="py-3 text-center">{{__('messages.category')}}</th>
            ...
            <tbody>
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <x-table-data class="text-center" value="{{ $item->user?->name}}" />
                            ...
                            <div class="flex items-start justify-center gap-3">
                                @can('update news')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/news_images/' . $item->id) }}"
                                ...
                                @can('view news')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('news/' . $item->id) }}" @mouseenter="tooltip = true"
