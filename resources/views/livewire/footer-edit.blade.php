    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-5 mb-5 lg:grid-cols-2">
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="copyright" class="block w-full mt-1" type="text" name="copyright"
                    wire:model='copyright' required autofocus placeholder="Copy Right" />
            ...
            <div class="col-span-1">
                ...
                <x-text-input id="copyright_kh" class="block w-full mt-1" type="text" name="copyright_kh"
                    wire:model='copyright_kh' required autofocus placeholder="Copy Right KH" />
