        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">0962345678</td>
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">long@gmail.com</td>
                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">male</td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3 justify-center">
                            ...
                            <div>
                                <!-- Modal toggle -->
                                <a data-tooltip-target="tooltip-edit-items" class="" href="{{ route('admin.users.edit', 3) }}" type="button">
