...
class ImageCategoryTableData extends Component
{
    use WithPagination;
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:image_categories,name',
    ...
    public function render(){
        ...
        return view('livewire.image-category-table-data', [
            'items' => $items,
        ]);
    }
}
