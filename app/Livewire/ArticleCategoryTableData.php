...
class ArticleCategoryTableData extends Component
{
    use WithPagination;
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:article_categories,name',
    ...
    public function render(){
        ...
        return view('livewire.article-category-table-data', [
            'items' => $items,
        ]);
    }
}
