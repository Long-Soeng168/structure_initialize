...
use App\Models\ArticleType as Type;

class ArticleTypeTableData extends Component
{
    use WithPagination;
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:article_types,name',
    ...
    public function render(){
        ...
        return view('livewire.article-type-table-data', [
            'items' => $items,
        ]);
    }
}
